        ...
        {showDemoModal && (
          <div className="fixed inset-0 z-55 flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-base font-bold text-slate-900 tracking-tight">Only for Demo</h3>
              <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                This link/option is for presentation and demonstration purposes only.
              </p>
              <button
                onClick={() => setShowDemoModal(false)}
                className="mt-5 w-full py-2 px-4 text-xs font-bold rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white transition-all cursor-pointer shadow-xs active:scale-95"
              >
                Got it
              </button>
            </motion.div>
